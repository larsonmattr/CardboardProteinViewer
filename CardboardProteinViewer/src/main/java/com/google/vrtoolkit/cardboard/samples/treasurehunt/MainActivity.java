...
public class MainActivity extends CardboardActivity implements CardboardView.StereoRenderer {
    ...
    public void onSurfaceCreated(EGLConfig config) {
        ...
        /**
         * Instead of using the ByteBuffers for the cube, use ByteBuffers implemented from representing a protein
         * structure as a model.
         */
        structure = new ProteinStructure(getApplicationContext());
        atomVerticesVec3 = structure.getVertices("A");
        ...
        List<Group> groups = structure.getAtomGroups("A");
        List<Atom> atoms = structure.getAtoms(groups);
        mOverlayView.show3DToast("Total number of groups " + groups.size() + ", atoms " + atoms.size());
    ...
    public void onDrawEye(EyeTransform transform) {
        ...
        // Note: this is drawing using client-side buffers.
        // Just need to pass a pointer to our data.
